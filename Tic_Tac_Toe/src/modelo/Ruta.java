...
public class Ruta {
    ...
    public static void cambiarRutas(TipoImagen tipoImagen) {
        if(tipoImagen == TipoImagen.CIRCULO) {
            ...
            LINEA1 = "/resources/CirculoEquis1.png";
            LINEA2 = "/resources/CirculoEquis2.png";
            LINEA3 = "/resources/CirculoEquis3.png";
            LINEA4 = "/resources/CirculoEquis4.png";
            LINEA5 = "/resources/CirculoEquis5.png";
            LINEA6 = "/resources/CirculoEquis6.png";
            LINEA7 = "/resources/CirculoEquis7.png";
            LINEA8 = "/resources/CirculoEquis8.png";
        }
    }
}

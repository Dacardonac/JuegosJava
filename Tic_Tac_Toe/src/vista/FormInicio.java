...
public class FormInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelFondo.setBackground(new java.awt.Color(14, 19, 48));
        ...
        lblCierre.setBounds(370, 10, 30, 40);

        titulo.setFont(new java.awt.Font("Showcard Gothic", 1, 36)); // NOI18N
        titulo.setForeground(new java.awt.Color(230, 251, 255));
        titulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titulo.setText("Tic Tac Toe");
        panelFondo.add(titulo);
        titulo.setBounds(0, 20, 420, 40);

        txtJugador1.setBackground(new java.awt.Color(214, 252, 249));
        txtJugador1.setFont(new java.awt.Font("Century Gothic", 1, 28)); // NOI18N
        ...
        txtJugador2.setFont(new java.awt.Font("Century Gothic", 1, 28)); // NOI18N
        txtJugador2.setForeground(new java.awt.Color(202, 105, 225));
        ...
        txtJugador2.addActionListener(this::txtJugador2ActionPerformed);
        ...
        lblIniciar.setFont(new java.awt.Font("Century Gothic", 1, 20)); // NOI18N

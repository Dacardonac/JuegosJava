...
public class FormTicTacToe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblCierre.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        ...
        lblCierre.setBounds(360, 10, 30, 40);

        imagen1.setText("imagen1");
        imagen1.setRuta("/resources/JugadorEquis.png");
        panelFondo.add(imagen1);
        imagen1.setBounds(75, 50, 50, 50);

        imagen2.setText("imagen1");
        imagen2.setRuta("/resources/JugadorCirculo.png");
        panelFondo.add(imagen2);
        imagen2.setBounds(275, 50, 50, 50);

        lblNombreJ1.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        ...
        lblNombreJ2.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        ...
        lblPuntajeJ1.setFont(new java.awt.Font("Century Gothic", 1, 36)); // NOI18N
        ...
        lblSeparador.setFont(new java.awt.Font("Century Gothic", 1, 26)); // NOI18N
        ...
        lblSeparador.setBounds(190, 50, 20, 60);

        lblPuntajeJ2.setFont(new java.awt.Font("Century Gothic", 1, 36)); // NOI18N
